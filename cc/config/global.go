...
func init() {
	...
	pctx.StaticVariable("ClangAsanLibDir", "${ClangPath}/lib64/clang/8.0.0/lib/linux")
	...
	pctx.StaticVariable("RSIncludePath", "${RSClangBase}/${HostPrebuiltTag}/${RSClangVersion}/lib64/clang/8.0.0/include")
